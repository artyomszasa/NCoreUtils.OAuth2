...
{
    public class TokenServiceEndpointsWrapper : ITokenService
    {
        private readonly ITokenServiceEndpoints _endpoints;

        public TokenServiceEndpointsWrapper(ITokenServiceEndpoints endpoints)
