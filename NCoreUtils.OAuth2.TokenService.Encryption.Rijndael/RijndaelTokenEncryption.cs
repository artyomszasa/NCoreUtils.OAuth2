...
{
    public sealed partial class RijndaelTokenEncryption : ITokenEncryption, IDisposable
    {
        ...
        public RijndaelTokenEncryption(RijndaelTokenEncryptionConfiguration configuration)
        {
        ...
        private void ThrowIfDisposed()
        {
            if (IsDisposed)
            {
                throw new ObjectDisposedException(nameof(RijndaelTokenEncryption));
            }
        }
