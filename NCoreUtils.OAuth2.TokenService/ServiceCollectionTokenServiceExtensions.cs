...
public static class ServiceCollectionTokenServiceExtensions
{
    public static IServiceCollection AddTokenService<
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TTokenEncryption,
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TTokenRepository
    >(
